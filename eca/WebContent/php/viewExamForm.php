...
<div class="disp_form">
        ...
        <a style="color:#e8491d;font:28px/1.5  Arial,Helvetica, sans-serif; margin: 30px;">Exam Form</a>
			...
			<button class="btn" onclick="return window.print(document.getElementById('disp_table').innerHTML)">Print</button>
			<div id="details" style="overflow-x:auto;">
				<table id="disp_table">
				 	...
				 	<tr>
				 		<td>College Code</td>
				 		<td><?php echo htmlentities($row['college_code']) ?></td>
				 	</tr>
				 	<tr>
				 		<td>Centre Code</td>
				 		<td><?php echo htmlentities($row['centre_code']) ?></td>
				 	</tr>
				 </table>
